    ...
    <div class="space-y-6 text-sm leading-relaxed text-gray-800">
      ...
      <div class="bg-blue-50 p-5 rounded-2xl border border-blue-200 space-y-2">
        ...
        <p class="text-xs text-blue-950 leading-relaxed">
          <b>• 국내 반도체(삼성전자, SK하이닉스) 영향:</b> 엔비디아 및 필라델피아 반도체 지수의 단기 차익 실현 출회는 코스피 반도체 대장주의 외국인 순매도 유출을 자극할 수 있으나, HBM3e/HBM4 실질 수혜 모멘텀은 유효합니다.
        </p>
        <p class="text-xs text-blue-950 leading-relaxed">
          <b>• 포트폴리오 대응 전략:</b> 지수 상방이 제한되는 변동성 장세에서는 무리한 추격 매수를 자제하고, 확실한 실적 가이던스를 입증한 대형 플랫폼주 및 고배당·가치주 위주의 분할 매수 접근이 바람직합니다.
        </p>
      </div>
